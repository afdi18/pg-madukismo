...
class DashboardController extends Controller
{
    ...
    public function antrianSummaryDashboard(): JsonResponse
    {
        $summary = DB::connection('sqlsrv')->selectOne(
            "SELECT
                COUNT(CASE WHEN NOT TGL_MSK IS NULL AND BRUTTO IS NULL AND TGL_BATAL IS NULL THEN SPA END)+COUNT(CASE WHEN NOT TGL_MSK IS NULL AND NOT BRUTTO IS NULL AND NETTO IS NULL AND NO_LORI IS NULL THEN SPA END) AS antrian_truk,
